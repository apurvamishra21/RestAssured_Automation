...
public class DeSerielizeTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String[]  courseTitles = {"Protractor" , "SeleniumWebDriver Java" , "Cypress"};
	...
	//	we have to explicitly tell restassured test that the pojo class ins in which formTat ex: json  or ? 
		...
		//Get the coursenames of webAutomation
		//when we dont know the size of array we nedd to go for arraylist
		//actual course titles are in array and expected are in arraylist now we need to compare both
		
		ArrayList<String> a = new ArrayList<String>();
		
		List<com.pojo.WebAutomation> w = gc.getCourses().getWebAutomation();
		...
		//we are converting array int arraylist so that its easy to compare using equals
